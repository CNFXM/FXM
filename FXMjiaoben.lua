...
getfenv().ConfigDeathGlove = {    HitboxVisible = false,MusicThemeId = 18382734796}loadstring(game:HttpGet("https://raw.githubusercontent.com/Yuna-ux/Slap-battles/refs/heads/main/Death_glove_V4.lua"))()
end)

about:Button("戴夫手套",function()
local function NetworkEvent(Name)	local success, error = pcall(function()		for i,v in pairs(game:GetService("ReplicatedStorage")._NETWORK:GetChildren()) do			if v:IsA("RemoteEvent") and not v.Name:find("Radio") then				v:FireServer(Name)			end		end	end)endNetworkEvent("mortis")NetworkEvent("Dave")
loadstring(game:HttpGet('https://pastefy.app/Tau7Gnno/raw'))()
end)

about:Button("超本能手套",function()
MuiSetting = {	HideClientVFX = false,	MuteClientSFX = false,	ShowHitboxes = false,}loadstring(game:HttpGet('https://raw.githubusercontent.com/DonjoScripts/Public-Scripts/refs/heads/Slap-Battles/MUI%5BGloveCustom%5D.lua'))()
end)
