...
about:Button("音乐1", function()
    ...
    local sound = Instance.new("Sound")
    -- 2. 指定音频资源ID（齐天大圣相关音效）
    sound.SoundId = "rbxassetid://9407154650048"
    -- 3. 设置为循环播放
    sound.Looped = true
    -- 4. 挂载到工作区（确保能正常播放）
    sound.Parent = game.Workspace
...
about:Button("音乐2", function()
    ...
    local sound = Instance.new("Sound")
    -- 2. 指定音频资源ID（齐天大圣相关音效）
    sound.SoundId = "rbxassetid://12081749107898"
    -- 3. 设置为循环播放
    sound.Looped = true
    -- 4. 挂载到工作区（确保能正常播放）
    sound.Parent = game.Workspace
...
about:Button("音乐6", function()
    ...
    local sound = Instance.new("Sound")
    -- 2. 指定音频资源ID（齐天大圣相关音效）
    sound.SoundId = "rbxassetid://119936139925486"
    -- 3. 设置为循环播放
    sound.Looped = true
    -- 4. 挂载到工作区（确保能正常播放）
    sound.Parent = game.Workspace
...
about:Button("音乐9", function()
    ...
    local sound = Instance.new("Sound")
    -- 2. 指定音频资源ID（齐天大圣相关音效）
    sound.SoundId = "rbxassetid://84449686918308"
    -- 3. 设置为循环播放
    sound.Looped = true
    -- 4. 挂载到工作区（确保能正常播放）
    sound.Parent = game.Workspace
...
about:Button("音乐12", function()
    ...
    local sound = Instance.new("Sound")
    -- 2. 指定音频资源ID（齐天大圣相关音效）
    sound.SoundId = "rbxassetid://93218265275853"
    -- 3. 设置为循环播放
    sound.Looped = true
    -- 4. 挂载到工作区（确保能正常播放）
    sound.Parent = game.Workspace
...
about:Button("音乐13", function()
    ...
    local sound = Instance.new("Sound")
    -- 2. 指定音频资源ID（齐天大圣相关音效）
    sound.SoundId = "rbxassetid://82996583445133"
    -- 3. 设置为循环播放
    sound.Looped = true
    -- 4. 挂载到工作区（确保能正常播放）
    sound.Parent = game.Workspace
