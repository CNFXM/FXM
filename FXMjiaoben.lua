...
about:Slider('当前血量', 'Sliderflag', 100, 1, 1000,false, function(Value)
        game.Players.LocalPlayer.Character.Humanoid.Health = Value
end)

about:Slider('最大血量', 'Sliderflag', 100, 1, 1000,false, function(Value)
        game.Players.LocalPlayer.Character.Humanoid.MaxHealth = Value
end)

about:Slider('旋转速度', 'Sliderflag', 0, 0, 1000,false, function(Value)
local speed = Value
...
about:Slider('触碰范围', 'Sliderflag', 0, 0, 1000,false, function(Value)
        _G.HeadSize = Value
    _G.Disabled = true 
