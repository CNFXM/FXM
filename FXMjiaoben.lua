...
pcall(function()
    ...
    local finalSize = _G.HeadSize <= 1 and 0.1 or _G.HeadSize
    ...
    v.Character.HumanoidRootPart.Transparency = _G.HeadSize <= 1 and 1 or 0.7
...
about:Textbox("旋转速度",false,function(Value)
    local speed = Value
