...
about:Button("巴掌最强",function()
script_key = "whistle"
falseloadstring(game:HttpGet('https://raw.githubusercontent.com/Umbrella-Scripter/Slap-Battles/refs/heads/main/MasteryFarmHub.lua'))()
end)
...
about:Button("刷巴掌3[装备雪手套]",function()
...
about:Button("刷巴掌4[装备樱桃手套]",function()
getgenv().Cherry_Slapfarm = {	Farm_Duration_Per_Server = 60,	Maximum_Slap_Gain_Per_Server = 100,	Amount_Slap_Wanted = 100000,	Auto_Collect_Slapple = true,	Auto_Collect_Orbs = true,	Anti_Moderator = true}loadstring(game:HttpGet('https://pastefy.app/7apzaaPa/raw'))()
end)
