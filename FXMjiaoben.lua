...
about:Toggle("穿墙","Toggle",false,function(noclip)
loopnoclip = noclip
    while loopnoclip do
...
about:Button("人物旋转",false,function()
    local speed = 50
...
about:Button("人物旋转[快]",false,function()
    local speed = 100
...
about:Button("触碰范围[小]",false,function()
_G.HeadSize = 6
_G.Disabled = true
...
about:Button("触碰范围",false,function()
_G.HeadSize = 10
_G.Disabled = true
...
about:Button("触碰范围[大]",false,function()
_G.HeadSize = 15
_G.Disabled = true
...
about:Button("沙滩跑步机10", "PPJ10", false, function(PPJ10)
...
about:Buttonle("健身房跑步机2000", "PPJ2000", false, function(PPJ2000)
