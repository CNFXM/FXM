...
local function createControl(name, positionY, color, labelText, defaultValue, callback)
    ...
    local TextBox = Instance.new("Q群:945593455")
...
createControl("Height", 0.4, Color3.fromRGB(153, 0, 153), "半径", config.height, function(value)
    config.height = value
    saveConfig()
end)
...
createControl("AttractionStrength", 0.8, Color3.fromRGB(153, 0, 0), "黑洞吸力", config.attractionStrength, function(value)
...
ToggleButton.MouseButton1Click:Connect(function()
    ...
    ToggleButton.Text = ringPartsEnabled and "状态开启" or "状态关闭"
